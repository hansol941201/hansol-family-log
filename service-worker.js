const CACHE='hansol-records-v13';
const ASSETS=['./','index.html','style.css','skin.css','theme.css','app.js','db.js','pdf.js','backup.js','audio.js','utils.js','manifest.json','icons/icon-192.png','icons/icon-512.png'];
