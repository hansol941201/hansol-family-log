window.DB=(()=>{const NAME='hansol-records',VERSION=1;let db;
  ...
  function normalizeDay(day){
    ...
    return{...day,activities,soloCare,childcare:day.childcare&&typeof day.childcare==='object'?day.childcare:{},chores:day.chores&&typeof day.chores==='object'?day.chores:{},itemTimes:day.itemTimes&&typeof day.itemTimes==='object'?day.itemTimes:{},bedtimeDetail:day.bedtimeDetail&&typeof day.bedtimeDetail==='object'?day.bedtimeDetail:{},daycarePrepMemo:day.daycarePrepMemo||'',choreMemo:day.choreMemo||'',sleepTime:day.sleepTime||'',memo:day.memo||''};
  }
  function emptyDay(date){return normalizeDay({date,activities:{},soloCare:[],childcare:{},itemTimes:{},bedtimeDetail:{},daycarePrepMemo:'',sleepTime:'',chores:{},choreMemo:'',memo:''})}
